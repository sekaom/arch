...
echo "set language done"
echo "archlinux" >> /etc/hostname
echo "set host name done"
echo "
127.0.0.1 localhost
::1 localhost
127.0.1.1 sekaom.localdomain sekaom" >> /etc/hosts
echo "set hosts done"
echo "add user sekaom"
useradd -m -G wheel -s /bin/zsh sekaom
echo "set server"
